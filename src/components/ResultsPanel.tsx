      ...
      <div className="flex-1 overflow-hidden">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <button
                    ...
                    className={`mt-2 text-sm underline hover:no-underline ${isDark ? 'text-red-300' : 'text-red-600'
                      }`}
                  >
                    Dismiss
                  </button>
        ...
        {result && !loading && !error && (
          <div className="h-full flex flex-col">
            {/* Result Header */}
            <div className={`px-4 py-3 border-b transition-colors ${isDark ? 'border-gray-700' : 'border-gray-200'
              }`}>
            ...
            <div className="flex-1 overflow-auto p-4">
              <pre className={`whitespace-pre-wrap text-sm leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-700'
                }`}>
                {result.response}
              </pre>
            </div>
